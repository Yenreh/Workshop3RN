...
A diferencia de problemas de clasificación donde se puede usar división aleatoria, en series temporales es crítico preservar el orden cronológico para evitar data leakage y simular predicción realista hacia el futuro.

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../output/images/data_division.png}
\caption{División temporal de datos para entrenamiento, validación y prueba}
\end{figure}
...
La normalización se ajustó únicamente con datos de entrenamiento y se aplicó consistentemente a validación y prueba para evitar data leakage.
...
\bibitem{chollet2021}
Chollet, F. (2021).
\textit{Deep Learning with Python, Second Edition}.
Manning Publications. \\
\url{https://www.manning.com/books/deep-learning-with-python-second-edition}

\bibitem{taller3_enunciado}
Chaves, D. (2025).
Taller No. 3: Predicción promedio del valor de acciones del mercado con redes LSTM y GRU.
\textit{Universidad del Valle - Redes Neuronales}. \\
Material del curso

\bibitem{diapositivas_bptt}
Chaves, D. (2025).
Diapositivas: Backpropagation en RNN.
\textit{Universidad del Valle - Redes Neuronales}. \\
Material del curso

\bibitem{diapositivas_estrategias}
Chaves, D. (2025).
Diapositivas: Estrategias de implementación RNN.
\textit{Universidad del Valle - Redes Neuronales}. \\
Material del curso

\bibitem{diapositivas_lstm}
Chaves, D. (2025).
Diapositivas: Long Short-Term Memory (LSTM) Network.
\textit{Universidad del Valle - Redes Neuronales}. \\
Material del curso

\bibitem{ejemplo_lstm}
Chaves, D. (2025).
Ejemplo LSTM (no calificable).
\textit{Universidad del Valle - Redes Neuronales}. \\
Material del curso

\bibitem{diapositivas_gru}
Chaves, D. (2025).
Diapositivas: Gated Recurrent Unit (GRU) Network.
\textit{Universidad del Valle - Redes Neuronales}. \\
Material del curso
...
\bibitem{tensorflow_docs}
TensorFlow Documentation (2025).
Recurrent Neural Networks (RNN) with Keras.
\url{https://www.tensorflow.org/guide/keras/rnn}

\bibitem{keras_lstm}
Keras Documentation (2025).
LSTM layer.
...
Keras Documentation (2025).
GRU layer.
\url{https://keras.io/api/layers/recurrent_layers/gru/}
